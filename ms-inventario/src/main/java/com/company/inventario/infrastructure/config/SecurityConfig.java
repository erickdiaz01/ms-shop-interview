...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityFilterChain(ServerHttpSecurity http) {
        ...
        //
        // POR QUE es un if y no un else:
        //   Si llamamos .oauth2ResourceServer(oauth2 -> oauth2.jwt(...)) sin decoder
        //   explicito, Spring intenta crear uno automaticamente buscando un bean
        //   ReactiveJwtDecoder o la propiedad issuer-uri. En tests y local no existe
        //   ninguno → NoSuchBeanDefinitionException → contexto no levanta.
        //
